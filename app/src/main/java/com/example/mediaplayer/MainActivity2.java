...
import android.media.MediaPlayer; //it is a class used to play media files
...
public class MainActivity2 extends AppCompatActivity {
    ...
    ImageView img;
    SeekBar seekbar;
    Handler mHandler=new Handler(); // it allows to send and process message & runnable objects
    Runnable mRunnable; //it is a interface used to execute code in threads
